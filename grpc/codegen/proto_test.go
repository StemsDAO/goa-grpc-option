...
func TestProtoFiles(t *testing.T) {
	cases := []struct {
		...
		{"multiple-methods-same-return-type", testdata.MultipleMethodsSameResultListDSL, testdata.MultipleMethodsSameResultListProtoCode},
...
func TestMessageDefSection(t *testing.T) {
	cases := []struct {
		...
		{"result-type-list", testdata.MessageResultTypeListDSL, testdata.MessageResultTypeListCode},
		{"user-type-with-list", testdata.MessageUserTypeWithListDSL, testdata.MessageUserTypeWithListCode},
