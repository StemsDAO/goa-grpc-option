...
func TestService(t *testing.T) {
	cases := []struct {
		...
		{"result-list-multiple-views", testdata.ResultListMultipleViewsMethodDSL, testdata.ResultListMultipleViewsMethod},
		{"result-with-other-result", testdata.ResultWithOtherResultMethodDSL, testdata.ResultWithOtherResultMethod},
		{"result-with-result-list", testdata.ResultWithResultListMethodDSL, testdata.ResultWithResultListMethod},
