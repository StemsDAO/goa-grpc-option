...
func TestDecode(t *testing.T) {
	cases := []struct {
		...
		{"body-union", testdata.PayloadBodyUnionDSL, testdata.PayloadBodyUnionDecodeCode},
		{"body-union-validate", testdata.PayloadBodyUnionValidateDSL, testdata.PayloadBodyUnionValidateDecodeCode},
		{"body-union-user", testdata.PayloadBodyUnionUserDSL, testdata.PayloadBodyUnionUserDecodeCode},
		{"body-union-user-validate", testdata.PayloadBodyUnionUserValidateDSL, testdata.PayloadBodyUnionUserValidateDecodeCode},
